      ...
      <nav class="navbar navbar-expand-lg navbar-light  ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="#" id="pers_details">Personal Details</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="displayEmp.php" id="employees">Employees</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="displayCust.php" id="customers">Customers</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="custProfile.php?logout=true">Logout</a>
            </li>
          </ul>
        </div>
      </nav>
