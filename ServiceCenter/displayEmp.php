...
$chk_sql = mysqli_query($connect, "select * from employee");
        ...
        <div class="containers-fluid">
            ...
            <div class="row">
                <table class="user-details">
                    ...
                    <?php
                    while ($emp_data = mysqli_fetch_array($chk_sql)) {
                        $empname = $emp_data['employee_name'];
                        $empcontno = $emp_data['employee_contact'];
                        $empemail = $emp_data['employee_email'];
                        $empaddress = $emp_data['employee_address'];
                    ?>
                        <tr>
                            <td><?php echo $empname; ?></td>
                            <td><?php echo $empcontno; ?></td>
                ...
                <button type="button" class="btn btn-dark btn-lg" style="margin-top: 3%;" id="add_Employee"><i class="fas fa-tools" style="margin-right: 4px;"></i> Add Employee</button>
